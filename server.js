...
// CREATE a new user (HTTP method POST) at endpoint /app/new/*added user*/
...
// DELETE a single user (HTTP method DELETE) at endpoint /app/delete/user/:id (deleted the get statement)
